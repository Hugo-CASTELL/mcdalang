...
public class McdalangParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, T__48=49, T__49=50, ID=51, FLOAT=52, INT=53, 
		STRING=54, CHAR=55, NEWLINE=56, WS=57, COMMENT_ML=58, COMMENT_SL=59;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "ID", "FLOAT", "INT", "STRING", "CHAR", "NEWLINE", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 143552255399494040L) != 0) );
			}
		}
	...
	public final FuncCallContext funcCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71494661264375824L) != 0)) {
				{
				setState(141);
				expr();
				setState(146);
