...
public class McdalangParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, ID=42, FLOAT=43, INT=44, STRING=45, CHAR=46, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "ID", "FLOAT", "INT", "STRING", "CHAR", 
			"NEWLINE", "WS", "COMMENT_ML", "COMMENT_SL"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 145135583560072L) != 0) );
			}
		}
	...
	public final FuncCallContext funcCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 139637976727568L) != 0)) {
				{
				setState(121);
				expr();
				setState(126);
